...
client.login(process.env.token).catch(err => { console.log('Bota giriş yapılırken başarısız olundu!!') })
...
client.on("userUpdate", async (stg, yeni) => {
  var sunucu = client.guilds.cache.get('846306314506076221'); // Buraya Sunucu ID
  var uye = sunucu.members.cache.get(yeni.id);
  var tag = "✫"; // Buraya Ekip Tag
  var tagrol = "846306314577379329"; // Buraya Ekip Rolünün ID
  var logKanali = "847430298912555028"; // Loglanacağı Kanalın ID
